	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ea:	0f be 80 c8 0d 80 00 	movsbl 0x800dc8(%eax),%eax
  8001f1:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003b5:	50                   	push   %eax
  8003b6:	68 e0 0d 80 00       	push   $0x800de0
  8003bb:	53                   	push   %ebx
  8003bc:	56                   	push   %esi
  ...
  8003cd:	52                   	push   %edx
  8003ce:	68 e9 0d 80 00       	push   $0x800de9
  8003d3:	53                   	push   %ebx
  8003d4:	56                   	push   %esi
  ...
  8003f2:	b8 d9 0d 80 00       	mov    $0x800dd9,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800af4:	e8 f2 f5 ff ff       	call   8000eb <vcprintf>
	cprintf("\n");
  800af9:	c7 04 24 bc 0d 80 00 	movl   $0x800dbc,(%esp)
